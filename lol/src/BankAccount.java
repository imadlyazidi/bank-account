...
public class BankAccount extends JFrame {
   ...
   * Accountnum Account number of customer
   * Balance Starting intial balance of account
   */
    ...
    private void createUserInterface() {
        ...
        WithdrawJLabel.setBounds(8, 104, 80, 23);
        ...
        WithdrawJTextField.setBounds(112, 104, 80, 21);
    ...
    public static void main(String[] args) {
        ...
        // so I can check to see if the values are empty later
    	try {
